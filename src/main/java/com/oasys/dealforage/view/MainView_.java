...
import com.oasys.dealforage.service.ProductService_;
...
@Route("aa")
public class MainView_ extends VerticalLayout {

    private final ProductService_ productService;
    private final Grid<Product> productGrid = new Grid<>(Product.class);
    private final List<Product> selectedProducts = new ArrayList<>();
    private int currentPage = 1;
    private final int pageSize = 20;

    public MainView_(ProductService_ productService) {
